...
export class UserController {
  ...
  async deleteProfilePicture(
    @Query() deleteUserProfilePictureDto: DeleteUserProfilePictureDto,
    @Req() request: any
  ) {
    return await this.userService.deleteProfilePicture(
      deleteUserProfilePictureDto,
      request.raw.decoded.id
    );
  }
  ...
  async getUserById(
    ...
    if (location && expoPushToken) {
      ...
      return await this.userService.updateAndGetUserById(
        id,
        newLocation,
        expoPushToken
      );
  ...
  async deleteConsumableImage(
    ...
    return await this.userService.removeConsumableImage(
      consumableId,
      request.raw.decoded.id
    );
  }
  ...
  async createConsumable(
    @Body() createConsumableItemDto: CreateConsumableDto,
    @Req() request: any
  ) {
    return this.userService.createConsumable(
  ...
  async updateConsumable(
    ...
    return this.userService.updateConsumable(
      createConsumableItemDto,
      request.raw.decoded.id
    );
  }
  ...
  async createConsumableItem(
    @Body() createConsumableItemDto: ConsumableItemDto,
    @Req() request: any
  ) {
    return this.userService.createConsumableItem(
      createConsumableItemDto,
      request.raw.decoded.id
    );
  }
  ...
  async deleteConsumableItem(
    ...
    return this.userService.deleteConsumableItem(
      itemId,
      request.raw.decoded.id
    );
  }
  ...
  async updateConsumableItem(
    ...
    return this.userService.updateConsumableItem(
      createConsumableItemDto,
      request.raw.decoded.id
    );
  }
  ...
  async createTicket(
    ...
    return this.userService.createTicket(
      createTicketDto,
      request.raw.decoded.id
    );
  }
  ...
  async updateTicket(
    ...
    return this.userService.updateTicket(
      updateTicketDto,
      request.raw.decoded.id
    );
  }
  ...
  async createTicketBase(
    @Body() createTicketBaseDto: TicketBaseDto,
    @Req() request: any
  ) {
    return this.userService.createTicketBase(
      createTicketBaseDto,
      request.raw.decoded.id
    );
  }
  ...
  async updateTicketBase(
    @Body() updateTicketBaseDto: TicketBaseDto,
    @Req() request: any
  ) {
    return this.userService.updateTicketBase(
      updateTicketBaseDto,
      request.raw.decoded.id
    );
  }
  ...
  async sendMessageToChannel(@Body() chatRoom: ChatRoom, @Req() request: any) {
    return this.userService.sendMessageToChatRoom(
      chatRoom,
      request.raw.decoded.id
    );
  }
  ...
  async requestMessages(
    ...
    @Query("lastTimeChecked") lastTimeChecked: string | null
  ) {
    return this.userService.requestMessagesFromLastMessageId(
      chatId,
      lastTimeChecked
    );
  }
